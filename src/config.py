...
QUERY_INSERT = {
    ...
    'abilities': 'INSERT INTO abilities (abilitie_id, name, effect) VALUES (%(abilitie_id)s, %(name)s, %(effect)s',
    'moves': 'INSERT INTO moves (move_id, name, effect) VALUES (%(move_id)s, %(name)s, %(effect)s',
